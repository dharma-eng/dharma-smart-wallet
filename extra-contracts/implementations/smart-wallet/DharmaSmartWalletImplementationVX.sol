...
import "../../../interfaces/DharmaSmartWalletImplementationVXInterface.sol";
...
/**
 * @title DharmaSmartWalletImplementationVX
 * @notice THIS IMPLEMENTATION IS OUTDATED, AND IS NOT USED IN PRODUCTION! It is
 * here as an example of what eventual borrow support might look like, but does
 * not support the full feature set of more recent production implementations.
 *
 * The VX implementation for the Dharma smart wallet is a non-custodial,
 ...
 * areas for improvement. The actual VX implementation will likely be quite
...
contract DharmaSmartWalletImplementationVX is
  ...
  DharmaSmartWalletImplementationVXInterface {
  ...
  uint256 internal constant _DHARMA_SMART_WALLET_VERSION = uint256(-1);
   ...
   * actions in VX include Cancel (0), SetUserSigningKey (1), Generic (2), 
