...
interface DharmaKeyRingFactoryV4Interface {
  function newKeyRing(
...
contract DharmaDeploymentHelperV2 {

  DharmaSmartWalletFactoryV3Interface internal immutable _WALLET_FACTORY;

  DharmaKeyRingFactoryV4Interface internal immutable _KEYRING_FACTORY;
  ...
  constructor(
    ...
    _KEYRING_FACTORY = DharmaKeyRingFactoryV4Interface(keyRingFactory);
