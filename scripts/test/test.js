...
async function test(testingContext) {
  ...
  const message = (
    tester.DharmaKeyRegistryV1.options.address +
  ...
  await tester.runTest(
    ...
    true,
    value => {
      assert.strictEqual(value, tester.DharmaKeyRegistryV1.options.address)
    }
  )
  ...
  const DharmaSmartWalletImplementationV0 = await tester.runTest(
    ...
    tester.DharmaSmartWalletImplementationV0Deployer,
    '',
    'deploy'
  )
  ...
  const DharmaSmartWalletImplementationV1 = await tester.runTest(
    ...
    tester.DharmaSmartWalletImplementationV1Deployer,
    '',
    'deploy'
  )
  ...
  const DharmaSmartWalletImplementationV2 = await tester.runTest(
    ...
    tester.DharmaSmartWalletImplementationV2Deployer,
    '',
    'deploy'
  )
  ...
  const DharmaSmartWalletImplementationV5 = await tester.runTest(
    ...
    tester.DharmaSmartWalletImplementationV5Deployer,
    '',
    'deploy'
  )
