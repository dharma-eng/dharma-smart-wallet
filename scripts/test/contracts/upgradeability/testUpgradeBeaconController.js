...
async function testUpgradeBeaconController(
  ...
  await tester.runTest(
    ...
    'upgrade',
    'send',
    [smartWalletUpgradeBeaconAddress, smartWalletControllerContract.options.address],
    false,
    receipt => {},
    tester.addressTwo
  )
  ...
  await tester.runTest(
    ...
    'upgrade',
    'send',
    [keyRingUpgradeBeaconAddress, smartWalletControllerContract.options.address]
  )
  ...
  await tester.runTest(
    ...
    true,
    value => {
      assert.strictEqual(value, smartWalletControllerContract.options.address)
    }
  )
